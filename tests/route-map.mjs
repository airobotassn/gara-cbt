...
const CASES = [
  ...
  // 나머지 대표값
  // "시험 보러 왔어" 는 일정·접수다(2026-09-22) — 응시권 든 사람은 마이페이지 카드로 /exam 에 들어간다.
  ['시험 보러 왔어', '/plan'], ['응시하기', '/plan'], ['시험 시작', '/plan'],
  ['모의고사', '/exam/check'], ['자격증 발급', '/certificate'],
  // 2026-09-22 점검에서 어디로도 못 가던 말들.
  ['내 응시권', '/mypage/attempts'], ['응시 현황', '/mypage/attempts'], ['닉네임 변경', '/mypage/attempts'], ['국가 변경', '/mypage/attempts'],
  ['칭호', '/hub'], ['친구 초대', '/hub'], ['코인 선물', '/hub'],
  ['회원 탈퇴', '/terms'], ['계정 삭제', '/terms'],

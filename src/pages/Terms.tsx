...
export const ARTICLES: { title: string; lead?: string; items?: string[] }[] = [
  {
    title: '제1조 (목적)',
    lead: '본 약관은 글로벌 AI 로봇협회(이하 "협회")가 제공하는 웹사이트 및 관련 서비스(이하 "서비스")의 이용과 관련하여 "협회"와 이용자(이하 "유저") 간의 권리·의무 및 책임사항을 규정함을 목적으로 합니다.',
  },
  {
    title: '제2조 (용어의 정의)',
    ...
    items: [
      ...
      '"유저"란 본 약관에 동의하고 Google 로그인을 통해 "서비스" 이용계약을 체결한 자를 의미합니다.',
  ...
  },
  {
    ...
    items: [
      '"협회"는 본 약관을 "서비스" 초기 화면 또는 가입 화면에 게시합니다.',
      '"협회"는 관련 법령을 위반하지 않는 범위 내에서 본 약관을 개정할 수 있습니다.',
      '약관을 개정하는 경우 적용일자 및 개정 사유를 명시하여 적용일 7일 전부터 공지합니다. "유저"에게 불리한 개정의 경우 30일 전부터 공지합니다.',
      '"유저"가 개정 약관의 적용일 이후에도 "서비스"를 계속 이용하는 경우 개정 약관에 동의한 것으로 봅니다.',
    ],
  },
  {
    title: '제4조 (가입 및 로그인)',
    items: [
      '"서비스"는 "Google 로그인"을 통한 "유저"에 한하여 제공됩니다.',
      '"협회"는 Google이 제공하는 범위 내에서 "유저"의 이메일, 이름, 프로필 이미지 등 최소한의 정보만 확인합니다.',
      'Google 계정의 관리 책임은 "유저"에게 있으며, 계정 관리 소홀로 인해 발생하는 손해에 대하여 "협회"는 책임을 지지 않습니다.',
      ...
      // 개인정보보호법 §22-2 — 만 14세 미만 아동의 개인정보는 법정대리인 동의 없이 처리할 수 없다.
      //   우리는 법정대리인 동의 절차를 두지 않으므로 **가입 연령을 제한**하는 쪽으로 정했다.
      //   실제 판정은 로그인 직후 동의 게이트(`/onboarding/terms`)가 한다 — 문구만 바꾸면 안 된다.
      '"서비스"는 만 14세 이상만 가입할 수 있습니다. "유저"는 최초 로그인 시 만 14세 이상임을 확인하고 본 약관 및 개인정보처리방침에 동의해야 하며, 동의 전에는 "서비스"를 이용할 수 없습니다.',
      '만 14세 미만임이 확인된 경우 "협회"는 이용 승낙을 거부하거나 이용계약을 해지하고 관련 개인정보를 지체 없이 파기합니다.',
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      '"협회"는 "서비스" 운영에 필요한 최소한의 정보만 처리하며, "유저"의 동의 없이 제3자에게 제공하지 않습니다. 단, 법령에 의한 경우는 예외로 합니다.',
  ...
  {
    title: '제9조 (유저의 의무)',
    lead: '"유저"는 다음 각 호의 행위를 하여서는 안 됩니다.',
    items: [
  ...
  {
    title: '제10조 (이용자격 제한 및 해지)',
    items: [
      '"협회"는 "유저"가 본 약관을 위반하거나 "서비스" 운영을 방해하는 경우, 사전 통지 후 이용을 제한하거나 이용자격을 박탈할 수 있습니다. 긴급한 경우 이용 제한 또는 이용자격 박탈을 먼저 시행하고 사후 통지할 수 있습니다.',
      '"유저"는 언제든지 "서비스" 내 탈퇴 기능을 이용하거나 Google 계정 연동을 해제함으로써 이용계약을 해지할 수 있습니다.',
    ],
  },
  {
    title: '제11조 (지식재산권)',
    items: [
      ...
      '"유저"는 "협회"의 사전 서면 동의 없이 "서비스"를 통해 취득한 정보를 영리 목적으로 이용하거나 제3자에게 제공할 수 없습니다.',
    ],
  },
  {
    title: '제12조 (면책)',
    items: [
      ...
      '"협회"는 "유저"의 귀책사유로 발생한 손해에 대하여 책임을 지지 않습니다.',

    ...
    <div className="bg-background text-on-surface mesh-bg min-h-screen flex flex-col">
      ...
      {sebNotice && (
        <div className="fixed inset-0 z-[100] bg-black/50 flex items-center justify-center p-4" onClick={() => setSebNotice(false)}>
          <div className="bg-white rounded-2xl p-8 max-w-md w-full text-center ambient-shadow" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              ...
              <button className="bg-white border border-outline-variant text-on-surface-variant font-label-md text-label-md px-6 py-3 rounded-xl hover:border-primary-container hover:text-primary-container transition-colors" onClick={() => setSebNotice(false)}>{t('common.close')}</button>
            </div>
          </div>
        </div>
      )}
        ...
        <div className="glass-panel rounded-2xl p-8 md:p-10 ambient-shadow flex flex-col gap-16">
          ...
          <section className="flex flex-col lg:flex-row gap-16 items-center">
            <div className="w-full lg:w-5/12 flex justify-center items-center">
              <div className="relative w-full aspect-square max-w-md rounded-full bg-white flex items-center justify-center overflow-hidden border border-surface-container-highest shadow-xl shadow-primary-container/5">
                ...
                <div className="z-10 w-2/3 h-2/3 flex items-center justify-center">
                  <img src="/logo.png" alt="GARA Logo" className="w-full h-full object-contain" />
                </div>
            ...
            <div className="w-full lg:w-7/12 flex flex-col gap-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4 mt-2">
                ...
                <button onClick={() => navigate('/exam/check')} className="bg-white text-on-surface-variant hover:text-primary-container font-title-md text-title-md px-10 py-4 rounded-xl transition-all border border-outline-variant hover:border-primary-container hover:shadow-md flex items-center justify-center gap-2">
                  시험환경 테스트
                </button>
              </div>
          ...
          {/* Exam Stats */}
          <section className="bg-white rounded-2xl border border-surface-container-highest p-10 shadow-sm">
          ...
          <section className="flex flex-col gap-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="flex flex-col sm:flex-row items-start gap-5 p-6 rounded-2xl bg-white border border-surface-container-highest shadow-sm hover:shadow-md transition-shadow">
              ...
              <div className="flex flex-col sm:flex-row items-start gap-5 p-6 rounded-2xl bg-white border border-error-container shadow-sm hover:shadow-md transition-shadow">

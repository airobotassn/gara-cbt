...
const VALID_DESTS = new Set([
  ...
  // CARIS 자격검정
  //   ⚠️ `/exam`(응시 게이트)은 목적지가 아니다(2026-09-22) — "시험 보러 왔어" 는 /plan 이다.
  '/guide', '/plan', '/exam/apply', '/exam/check', '/certificate',
  // 내 정보
...
export default function Landing() {
  ...
  // postLoginRedirect: 지정 경로로(예: SEB 진입 /exam/seb).
  //   (옛 `examIntent` — /exam 의 로그인 안내가 심던 표식 — 는 2026-09-22 에 그 안내와 같이 없앴다.)
  useEffect(() => {

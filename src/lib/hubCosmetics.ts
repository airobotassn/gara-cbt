...
export const SKINS: SkinDef[] = [
  ...
  // 대한민국 지역 8장 (2026-09-14) — **한국 UI 한 벌**(`ui: 'korea'`, 단청 구름·청록·금테)을 같이 들고 온다. 칩 '대한민국'.
  { key: 'kr_gangneung', partKey: 'skin_kr_gangneung', ui: 'korea', category: 'korea', iconDir: '/hub/ui-korea', bg: '/hub/bg-kr-gangneung.webp' },
  { key: 'kr_gyeonggi', partKey: 'skin_kr_gyeonggi', ui: 'korea', category: 'korea', iconDir: '/hub/ui-korea', bg: '/hub/bg-kr-gyeonggi.webp' },
  { key: 'kr_gwangju', partKey: 'skin_kr_gwangju', ui: 'korea', category: 'korea', iconDir: '/hub/ui-korea', bg: '/hub/bg-kr-gwangju.webp' },
  { key: 'kr_daegu', partKey: 'skin_kr_daegu', ui: 'korea', category: 'korea', iconDir: '/hub/ui-korea', bg: '/hub/bg-kr-daegu.webp' },
  { key: 'kr_daejeon', partKey: 'skin_kr_daejeon', ui: 'korea', category: 'korea', iconDir: '/hub/ui-korea', bg: '/hub/bg-kr-daejeon.webp' },
  ...
  // 풍경 5장(2026-09-15 · Z:「풍경 스킨」) — **풍경 UI 한 벌**(`ui: 'scenery'`) 공용. 칩 '풍경'.
  { key: 'scenery_desert', partKey: 'skin_scenery_desert', ui: 'scenery', category: 'scenery', iconDir: '/hub/ui-scenery', bg: '/hub/bg-scenery-desert.webp' },
  { key: 'scenery_saltflat', partKey: 'skin_scenery_saltflat', ui: 'scenery', category: 'scenery', iconDir: '/hub/ui-scenery', bg: '/hub/bg-scenery-saltflat.webp' },
  ...
  // 한옥 양반집 둘(2026-09-15 · 옛 Z:「배경 스킨」에서 국가별로 옮김) — 세계 칩 아시아에 서되 UI 는 **대한민국 벌**을 입는다(지시).
  { key: 'world_kr_hanok', partKey: 'skin_world_kr_hanok', ui: 'korea', category: 'world', region: 'asia', iconDir: '/hub/ui-korea', bg: '/hub/bg-world-kr-hanok.webp' },
  { key: 'world_kr_hanok2', partKey: 'skin_world_kr_hanok2', ui: 'korea', category: 'world', region: 'asia', iconDir: '/hub/ui-korea', bg: '/hub/bg-world-kr-hanok2.webp' },
  ...
  { key: 'world_gr_santorini', partKey: 'skin_world_gr_santorini', ui: 'world', category: 'world', region: 'europe', iconDir: '/hub/ui-world', bg: '/hub/bg-world-gr-santorini.webp' },
  ...
  { key: 'world_cn_greatwall', partKey: 'skin_world_cn_greatwall', ui: 'world', category: 'world', region: 'asia', iconDir: '/hub/ui-world', bg: '/hub/bg-world-cn-greatwall.webp' },
